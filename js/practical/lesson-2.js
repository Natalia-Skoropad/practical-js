...
Напишіть функцію logItems(array), яка приймає масив як аргумент і виводить у консоль кожен його елемент у форматі:
...
Додайте перевірку, що функція отримує саме масив, і якщо функція отримує масив - поверніть з функції найменше число, в іншому випадку - поверніть 'Sory, it is not an array!'.
...
Напишіть код для додавання усіх зарплат та збережіть його результат в змінній sum.
...
- винесіть перевірку на наявність властивостей в об'єкті в окремий метод exist(). Якщо вказані властивості в обʼєкті відсутні (тобто метод exist повертає false), методи sum і mult мають повертати рядок 'No such propeties'
